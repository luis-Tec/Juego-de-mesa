...
public class PintorMuestraUsuario extends JPanel implements MouseListener, MouseMotionListener {

    //Instancia de la clase metodos
    Metodos metodos = new Metodos();

    public PintorMuestraUsuario() {
    ...
    public void mouseClicked(MouseEvent e
        ...
        if (e.isShiftDown() == true) {
            ...
            if (CuadroDialogo == JOptionPane.YES_OPTION) {
                Login.cargarMapa.UsuariosMapas.dispose();
